...
namespace SISACO
{
    public partial class Form_AbrirOrdendeAcondicionamiento : Form
    {
        public Form_AbrirOrdendeAcondicionamiento()
        {
            InitializeComponent();
        }

        private void Form_AbrirOrden_Load(object sender, EventArgs e)
        {
